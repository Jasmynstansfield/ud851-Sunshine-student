...
public class MainActivity extends AppCompatActivity
{
    ...
    private ProgressBar mContentLoadingPB;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mContentLoadingPB = (ProgressBar) findViewById(R.id.pb_content_loading);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
    {
        ...
        {
            super.onPreExecute();
            mContentLoadingPB.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData)
        {
            ...
            mContentLoadingPB.setVisibility(View.INVISIBLE);
            if (weatherData != null)
            {
